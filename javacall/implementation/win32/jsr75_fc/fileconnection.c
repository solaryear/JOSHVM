...
javacall_result javacall_fileconnection_is_hidden(const javacall_utf16* fileName,
    ...
    if( fileNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_hidden(), file name is too long\n");
    ...
    if (INVALID_FILE_ATTRIBUTES == attrs) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_hidden(), file not found\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_is_readable(const javacall_utf16* pathName,
    ...
    if( pathNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_readable(), file name is too long\n");
        return JAVACALL_FAIL;
    }
    ...
    if(_waccess(wOsFilename, 0) == -1) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_readable(), file is not accessible\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_is_writable(const javacall_utf16* pathName,
    ...
    if( pathNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_writable(), file name is too long\n");
        return JAVACALL_FAIL;
    }
    ...
    if(_waccess(wOsFilename, 0) == -1) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_writable(), file is not accessible\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_set_hidden(const javacall_utf16* fileName,
	...
	int fileNameLen = javautil_wcslen(fileName);

    if( fileNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_set_hidden(), file name is too long\n");
        return JAVACALL_FAIL;
    }
    ...
    if(-1 == attrs) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_set_hidden(), cannot get file attributes\n");
        return JAVACALL_FAIL;
    }
    ...
    if(!SetFileAttributesW(wOsFilename, attrs)) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_set_hidden(), cannot set file attributes\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_set_readable(const javacall_utf16* pathName,
    ...
    wchar_t wOsFilename[JAVACALL_MAX_FILE_NAME_LENGTH]; // max file name
    int pathNameLen = javautil_wcslen(pathName);

    if( pathNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_set_readable(), file name is too long\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_set_writable(const javacall_utf16* pathName,
    ...
    if( pathNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_set_writable(), file name is too long\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_get_last_modified(const javacall_utf16* fileName,
    ...
    if( fileNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_get_last_modified(), file name is too long\n");
        return JAVACALL_FAIL;
    }
    ...
    if (_wstat(wOsFilename, &buf) == -1) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_get_last_modified(), file is not accessible\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_is_directory(const javacall_utf16* pathName,
    ...
    if( pathNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_is_directory(), file name is too long\n");
        return JAVACALL_FAIL;
    }
    ...
    attrs = GetFileAttributesW(wOsFilename);
    if(-1 == attrs) {
        javacall_logging_printf(JAVACALL_LOGGING_INFORMATION, JC_FC,  "Error: javacall_fileconnection_is_directory(), cannot get file attributes\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_create_dir(const javacall_utf16* dirName,
    ...
    if( dirNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_create_dir(), file name is too long\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_delete_dir(const javacall_utf16* dirName,
    ...
    if( dirNameLen > JAVACALL_MAX_FILE_NAME_LENGTH ) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_delete_dir(), file name is too long\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_dir_exists(const javacall_utf16* pathName,
    ...
    if(JAVACALL_OK != javacall_fileconnection_is_directory(pathName, pathNameLen, &res)) {
        javacall_logging_printf(JAVACALL_LOGGING_INFORMATION, JC_FC,  "Error: javacall_fileconnection_dir_exists(), cannot access directory\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_get_free_size(const javacall_utf16* pathName,
    ...
    if(0 != _getdiskfree(pathName[0] - (pathName[0] > 'Z' ? 'a' : 'A') + 1, &df)) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_get_free_size(), cannot get free space\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_get_total_size(const javacall_utf16* pathName,
    ...
    if(0 != _getdiskfree(pathName[0] - (pathName[0] > 'Z' ? 'a' : 'A') + 1, &df)) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_get_total_size(), cannot get total space\n");
        return JAVACALL_FAIL;
    }
...
javacall_result javacall_fileconnection_dir_content_size(const javacall_utf16* pathName,
    ...
    if (INVALID_HANDLE_VALUE == listHandle[0]) {
        javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_dir_content_size(), cannot open directory\n");
        return JAVACALL_FAIL;
    }
                ...
                if (JAVACALL_TRUE == includeSubdirs) {
                    ...
                    if (wcscmp(dir_data.cFileName, L".") && wcscmp(dir_data.cFileName, L"..")) {
                        ...
                        if (nestLevel >= MAX_DIRECTORY_NESTING_LEVEL - 1) {
                            ...
                            javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_dir_content_size(), directory nesting overflow\n");
                            return JAVACALL_FAIL;
                        }
                        ...
                        if (INVALID_HANDLE_VALUE == listHandle[nestLevel]) {
                            ...
                            javacall_logging_printf(JAVACALL_LOGGING_ERROR, JC_FC,  "Error: javacall_fileconnection_dir_content_size(), cannot open subdirectory\n");
                            return JAVACALL_FAIL;
                        }
                        nextExists = 1;
                        continue;
